...
const apps = [
  ...
  { name: "Connelix", glow: "rgba(229, 57, 53, 0.35)", color: "#ff5252", icon: <svg viewBox="0 0 24 24" className="w-6 h-6 md:w-7 md:h-7 xl:w-8 xl:h-8" fill="currentColor"><path d="M8 5v14l11-7z" /></svg> },
  ...
  { name: "PureX", glow: "rgba(224, 224, 224, 0.35)", color: "#ffffff", icon: <svg viewBox="0 0 24 24" className="w-6 h-6 md:w-7 md:h-7 xl:w-8 xl:h-8" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 3h12l4 6-10 12L2 9z" /></svg> },
