            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
                ...
                <div className="flex flex-col">
                    <ul className="list-none p-0 m-0 flex flex-col gap-3">
                        ...
                        <li><Link href="/own-a-ready-to-launch" className="text-[0.85rem] text-text-secondary transition-colors duration-300 hover:text-white">Own a Ready-to-Launch Connplex</Link></li>
