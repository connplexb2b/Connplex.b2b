...
export default function NewFranchisePage() {
    ...
    return (
        <div className="franchise-page">
            <Head>
                <title>Franchise Opportunities | Connplex Cinemas</title>
                <meta name="description" content="Partner with India's fastest-growing Cinema chain and bring a world-class cinema experience to your city." />
