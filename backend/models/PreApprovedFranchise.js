...
const preApprovedFranchiseSchema = new mongoose.Schema({
  fullName: {
    type: String,
  ...
  preApprovedCity: {
    type: String,
    required: [true, 'Pre-approved franchise city is required'],
    trim: true,
  },
  timeframe: {
    type: String,
  ...
  timestamps: true,
  collection: 'preapprovedfranchises'
});

const PreApprovedFranchise = mongoose.model('PreApprovedFranchise', preApprovedFranchiseSchema);
export default PreApprovedFranchise;
