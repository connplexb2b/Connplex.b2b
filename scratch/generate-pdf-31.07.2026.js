...
const pdfPath = path.join(__dirname, '../public/uploads/investors/4887120f-272d-4780-852b-9620e1f4e1ef/a3b92b23-3a1d-4001-8b43-982ee33df718.pdf');
...
const textLines = [
  ...
  "Regulations, 2015, we are pleased to inform you that \"CONNPLEX CINEMAS\" has been recognised",
  "as the \"FASTEST GROWING CINEMA CHAIN OF THE YEAR\" by the BIG CINE EXPO.",
  "",
  "The official announcement of the same is annexed herewith for your reference.",
  "",
...
if (investor) {
  let fileEntry = investor.files.find(f => f.id === 'a3b92b23-3a1d-4001-8b43-982ee33df718');
  if (!fileEntry) {
    fileEntry = {
      id: 'a3b92b23-3a1d-4001-8b43-982ee33df718',
      originalName: 'Intimation under Regulation 30 of SEBI(LODR) - 31.07.2026.pdf',
      storedName: 'a3b92b23-3a1d-4001-8b43-982ee33df718.pdf',
      url: '/uploads/investors/4887120f-272d-4780-852b-9620e1f4e1ef/a3b92b23-3a1d-4001-8b43-982ee33df718.pdf',
      mimeType: 'application/pdf',
      size: size,
      title: 'Intimation under Regulation 30 of SEBI(LODR) - 31.07.2026'
    };
    investor.files.push(fileEntry);
  } else {
    fileEntry.size = size;
    fileEntry.title = 'Intimation under Regulation 30 of SEBI(LODR) - 31.07.2026';
  }
