...
const SRC_PATH = "C:\\Users\\admin\\Downloads\\Pre-dispatch Notice_Newspaper Advt._14.09.2026 .pdf";
const FILE_ID = "g1409202-6000-4000-8000-000000000001";
const FILE_NAME = "Pre-dispatch Notice_Newspaper Advt._14.09.2026.pdf";
const STORED_NAME = `${FILE_ID}.pdf`;
const RELATIVE_URL = `/uploads/investors/${INVESTOR_ID}/${STORED_NAME}`;
const MIME_TYPE = "application/pdf";
const TITLE = "Pre-dispatch Notice_Newspaper Advt._14.09.2026";
  ...
  try {
    ...
    if (!investorDoc) {
      ...
      let updatedFiles = (investorDoc.files || []).filter(
        f => f.id !== FILE_ID && f.storedName !== STORED_NAME && f.title !== TITLE && f.originalName !== FILE_NAME
      );
